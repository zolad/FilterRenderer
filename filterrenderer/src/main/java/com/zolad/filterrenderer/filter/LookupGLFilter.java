...
import static com.zolad.filterrenderer.filter.base.GLFilter.VERTEX_SHADER;

public class LookupGLFilter extends GLFilter {
    ...
    protected int tableResId;
	private WeakReference<Context> mContext;
    public LookupGLFilter(Context context,int tableResId) {
    ...
    public int mLookupSourceTexture = GLConstant.NO_TEXTURE;

    @Override
    protected void onCreate(){
		super.onCreate();
		mLookupTextureUniform = GLES20.glGetUniformLocation(mProgramId, "inputImageTexture2");
		if (mContext.get() != null) {
			mLookupSourceTexture = ShaderHelper.loadTexture(mContext.get(), tableResId);
		}
    }
