 ...
 */
public class SharpenGLFilter extends GLFilter {
    ...
    public SharpenGLFilter() {
        this(0.0f);
    }
    
    public SharpenGLFilter(final float sharpness) {
    ...
    public void onCreate() {
        super.onCreate();
        mSharpnessLocation = GLES20.glGetUniformLocation(mProgramId, "sharpness");
        mImageWidthFactorLocation = GLES20.glGetUniformLocation(mProgramId, "imageWidthFactor");
        mImageHeightFactorLocation = GLES20.glGetUniformLocation(mProgramId, "imageHeightFactor");
    ...
    protected void onDrawArraysPre() {
        ...
        setFloat(mImageWidthFactorLocation, 1.0f / mIntputWidth);
        setFloat(mImageHeightFactorLocation, 1.0f / mIntputHeight);
    }
